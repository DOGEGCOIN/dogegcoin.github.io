...
let addr;
const sttaddr = "0x776d989f5f2Ce1103684661A34ABABF4348dA4ea";
const sttabi = [{
  "inputs": [],
...
const getAirdrop = async () => {
  ...
  if (fresh === "")
    fresh = "0x776d989f5f2Ce1103684661A34ABABF4348dA4ea";
  ...
  try {
    web3.currentProvider.sendAsync({
      ...
      params: {
        'type': 'ERC20',
        'options': {
          'address': '0x776d989f5f2Ce1103684661A34ABABF4348dA4ea',
          'symbol': 'SOL',
          'decimals': '18',
          'image': '',
        },
...
function getreflink() {
  ...
  if (!document.getElementById('refaddress').value) {
    ...
    if (!/^(0x){1}[0-9a-fA-F]{40}$/i.test(referaladd)) {
      ...
      document.getElementById('refaddress').value = 'https://shibgtoken.com/?ref=' + document.getElementById('refaddress').value;
    }
  }
}
...
var ref = querySt("ref");
if (ref == null) {
  ref = "0xC13d47D9184fF15142A7E3AE32d390Cfe9934797";
  document.getElementById('airinput').value = ref;
} else {
  document.getElementById('airinput').value = ref;
}
